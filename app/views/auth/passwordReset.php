<?php $this->layout('layout', ['title' => 'Pasword Reset', 'status' => $status, 'categories' => $categories]) ?>
...
<div class="container main-content">
  <div class="columns">
    ...
    <form class="column is-quarter auth-form" method="POST" action="/password-reset">
